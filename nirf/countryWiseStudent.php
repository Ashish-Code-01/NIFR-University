...
?>
        <div class="div">
            <form class="fw-bold" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()" autocomplete="off">
                <div class="mb-3">
                    <p class="text-center fs-4 ">Country Wise Student</p>
                </div>
				<div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="form-label">
                    Select element containing all counties and country codes
					</label>
                ...
                <div class="mb-3">
                    <label class="form-label">
                        Number of student country wise
                    </label>
                    <input type= number name="Country_wise_student" class="form-control" placeholder="Enter number of country wise student" required>
                </div>
