...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['calculate_marks'])) {
    ...
    // Here add the database connection and insert logic if needed //
}
?>
    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            ...
            <form method="post">
                <!-- NEP Initiatives -->
                <div class="mb-4">
                    <label class="form-label fw-bold">1. NEP Initiatives (Max 30 marks)</label>
                    <div class="row">
                        <?php
                        $nep_items = [
                        ...
                        foreach ($nep_items as $i => $label) {
                            ...
                            echo '<input class="form-check-input" type="checkbox" name="nep_initiatives[]" value="' . htmlspecialchars($label) . '" id="nep' . $i . '">';
                ...
                <div class="mb-4">
                    <label class="form-label fw-bold">2. Teaching-Learning Pedagogical Approaches (Max 20 marks)</label>
                    <div class="row">
                        <?php
                        $ped_items = [
                            "Blended Learning",
                ...
                <!-- Assessments -->
                <div class="mb-4">
                    <label class="form-label fw-bold">3. Student-Centric Assessments (Max 20 marks)</label>
                    <div class="row">
                        <?php
                        $assess_items = [
                            "Assessment Rubrics",
                ...
                <!-- MOOC Courses -->
                <div class="mb-4">
                    <label class="form-label fw-bold">4. MOOC Courses (Max 10 marks, 2 marks each)</label>
                    <input type="number" name="moocs" class="form-control" min="0">
                </div>

                <!-- E-Content -->
                <div class="mb-4">
                    <label class="form-label fw-bold">5. E-Content Development Credits (Max 15 marks)</label>
